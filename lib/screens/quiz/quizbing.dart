...
class QuizbingScreen extends StatefulWidget {
  const QuizbingScreen({Key? key}) : super(key: key);

  @override
  _QuizbingScreenState createState() => _QuizbingScreenState();
}

class _QuizbingScreenState extends State<QuizbingScreen> {
  List<QuizData> quizzes = [];
  String subjectName = 'Bahasa Inggris';
  bool isLoading = true;
  String? error;
  final int subjectId = 5; // ID for Bahasa Inggris
            ...
            Expanded(
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      'Quiz Bahasa Inggris yang harus dikerjakan',
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: screenHeight * 0.01),
            Text(
              'Belum ada quiz untuk mata pelajaran Bahasa Inggris saat ini',
              textAlign: TextAlign.center,
              style: TextStyle(
                fontSize: screenWidth * 0.035,
                color: Colors.white70,
    ...
    return RefreshIndicator(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return _buildQuizCard(quizzes[index], screenWidth, screenHeight);
        },
      ),
    );
  }
...
class QuizData {
  ...
  factory QuizData.fromJson(Map<String, dynamic> json) {
    return QuizData(
      ...
      judulQuiz: json['judul_quiz'] as String,
